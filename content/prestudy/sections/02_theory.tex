...
\begin{tabularx}{\textwidth}{l l >{\RaggedRight\arraybackslash}X}
    ...
    Framing & H1a & Die positive Darstellung des Accuracy Scores (z.B. «Diese Antwort ist zu 80\% korrekt») führt zu einem höheren AI Output Trust als die Kontrollbedingung ohne Score-Anzeige. \\
    ...
    \midrule
    AI-TAM & H2 & AI Output Trust hat einen positiven Einfluss auf die Perceived Usefulness. Nutzer, die den AI-Ausgaben vertrauen, bewerten das System als nützlicher für ihre Aufgaben. \\
    ...
    \midrule
    TAM & H4 & Die Perceived Usefulness hat einen positiven Einfluss auf die Behavioral Intention. Je nützlicher Nutzer Alva einschätzen, desto höher ist ihre Absicht, das System zukünftig zu nutzen. \\
    ...
    \midrule
    Mediation & H9 & Der Effekt des Framings auf die Behavorial Intention wird durch Explainable AI Trust partiell oder vollständig mediiert. Bei niedrigen Explainable AI Trust-Werten ist der Unterschied zwischen positivem und negativem Framing grösser als bei hohen Explainable AI Trust-Werten. \\
\end{tabularx}
