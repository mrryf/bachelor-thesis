...
\begin{table}[H]
    ...
    \begin{threeparttable}
        \caption{Experimentelles 3x2 Design: Manipulation von Framing und Konfidenz}
        \label{tab:experiment-design-3x2}
        \begin{tabularx}{\textwidth}{l X X}
            \toprule
             & \multicolumn{2}{c}{\textbf{Framing (UV 1)}} \\
            \cmidrule(lr){2-3}
            \textbf{Konfidenz (UV 2)} & \textbf{Positiver Frame} & \textbf{Negativer Frame} \\
            \midrule
...
\subsubsection{Treatment Check Stimulus}
