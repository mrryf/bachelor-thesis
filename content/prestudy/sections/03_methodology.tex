...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{ba_fryf_stimulus_design/sicherheit_hoch.pdf}
        \caption{Positiver Frame / Hohe Sicherheit}
        \label{fig:stimulus-pos-high}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{ba_fryf_stimulus_design/unsicherheit_tief.pdf}
        \caption{Negativer Frame / Hohe Sicherheit}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{ba_fryf_stimulus_design/sicherheit_mittel.pdf}
        \caption{Positiver Frame / Mittlere Sicherheit}
        \label{fig:stimulus-pos-mid}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{ba_fryf_stimulus_design/unsicherheit_mittel.pdf}
        \caption{Negativer Frame / Mittlere Sicherheit}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{ba_fryf_stimulus_design/sicherheit_tief.pdf}
        \caption{Positiver Frame / Niedrige Sicherheit}
        \label{fig:stimulus-pos-low}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{ba_fryf_stimulus_design/unsicherheit_hoch.pdf}
