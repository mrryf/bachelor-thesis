...
\begin{figure}[p]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{resources/design/ba_fryf_stimulus_design/sicherheit_hoch.pdf}
        \caption{Positiver Frame / Hohe Accuracy}
        \label{fig:stimulus-pos-high}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{resources/design/ba_fryf_stimulus_design/unsicherheit_tief.pdf}
        \caption{Negativer Frame / Hohe Accuracy}
        \label{fig:stimulus-neg-high}
    \end{subfigure}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{resources/design/ba_fryf_stimulus_design/sicherheit_mittel.pdf}
        \caption{Positiver Frame / Mittlere Accuracy}
        \label{fig:stimulus-pos-mid}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{resources/design/ba_fryf_stimulus_design/unsicherheit_mittel.pdf}
        \caption{Negativer Frame / Mittlere Accuracy}
        \label{fig:stimulus-neg-mid}
    \end{subfigure}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{resources/design/ba_fryf_stimulus_design/sicherheit_tief.pdf}
        \caption{Positiver Frame / Niedrige Accuracy}
        \label{fig:stimulus-pos-low}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{resources/design/ba_fryf_stimulus_design/unsicherheit_hoch.pdf}
        \caption{Negativer Frame / Niedrige Accuracy}
