...
\subsubsection[Technology Acceptance Model]{Technology Acceptance Model \parencite{Davis1987}}
...
\subsubsection[Artificial Intelligence-Technology Acceptance Model]{Artificial Intelligence-Technology Acceptance Model \parencite{Baroni2022}}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth, height=0.8\textheight, keepaspectratio]{resources/images/ba_faryf_ai_tam.jpg}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth, height=0.8\textheight, keepaspectratio]{resources/images/ba_faryf_messmodell.jpg}
