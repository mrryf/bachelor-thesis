...
\subsubsection{Technology Acceptance Model (Davis, 1987)}
...
\subsubsection{Artificial Intelligence-Technology Acceptance Model (Baroni et al., 2022)}
...
\paragraph{Validierung durch die BumpOut-Studie (Baroni et al., 2022)}
...
\paragraph{Attribute Framing nach Levin \& Gaeth (1988) und Dolgopolova (2021)}
